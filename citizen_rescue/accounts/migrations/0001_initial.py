# Generated by Django 5.2.16 on 2026-07-27 13:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_gate', models.CharField(blank=True, max_length=50, null=True)),
                ('on_duty', models.BooleanField(default=True)),
                ('user', models.OneToOneField(limit_choices_to={'role': 'SECURITY'}, on_delete=django.db.models.deletion.CASCADE, related_name='security_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
